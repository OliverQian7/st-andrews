...
class Composition {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Very minimal error checking and exception handling here, don't do this in
        // real code...
        String filePath = args[0];

        // I am not suggesting this is the best way of reading the contents of a file,
        // but hey, the topic is Java stream API...
